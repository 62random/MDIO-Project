...
//Variáveis de Decisão
 ...
 subject to{
 	...
 	forall(i in 1..n, j in 1..n: i != i_inicio || j != j_inicio) (sum(k in 1..n, l in 1..n) (X[i][j][k][l] - X[k][l][i][j]) == -1); 	//De um nodo sai menos um caminho do que a ele chegam (visto que o caminho mais curto para esse nodo termina nele)
}